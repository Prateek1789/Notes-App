                                     ...
                                     <div class="note-actions">
                                         ...
                                         <ul class="note-actions-list">
                                             <li class="note-action-items na-list-item-1">
                                                 <button type="button" data-action="star-note" class="note-action-btn btn-star">
                                             ...
                                             <li class="note-action-items na-list-item-2">
                                                 <button type="button" data-action="edit-note" class="note-action-btn btn-edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" >
                                             ...
                                             <li class="note-action-items na-list-item-3 hidden">
                                                <button type="button" data-action="restore-note" class="note-action-btn btn-restore">
                                             ...
                                             <li class="note-action-items na-list-item-4">
                                                 <button type="button" data-action="delete-note" class="note-action-btn btn-del">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
